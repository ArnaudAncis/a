...
\begin{frame}
  ...
  \code[font size=\small,width=.95\linewidth]{assignment-declaration.cpp}
  \begin{itemize}
...
\begin{frame}
  ...
  \code[font size=\small,width=.95\linewidth]{assignment-objects.cpp}
  \begin{itemize}
...
\begin{frame}
  ...
  \code[font size=\small,width=.95\linewidth]{assignment-pointers.cpp}
  \begin{itemize}
    \item Using {\tt x = y} where {\tt x} and {\tt y} are of type {\tt T*}
...
\begin{frame}
  ...
  \code[font size=\small,width=.95\linewidth]{assignment-references.cpp}
  \begin{itemize}
