\begin{frame}
  ...
  \code[frame=lines,width=.5\linewidth,font size=\small]{return-local-by-pointer.cpp}
  \begin{itemize}
...
\begin{frame}
  ...
  \begin{center}
    \begin{columns}
      \column{4cm}
      \code[frame=lines,width=.95\linewidth,font size=\small]{return-local-by-pointer.cpp}
      \column{4cm}
      \begin{tikzpicture}
        \memorylayout
