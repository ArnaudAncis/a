...
\begin{frame}
  ...
  \begin{center}
    ...
    \tt\only<handout:1->{\alert<handout:1>{m}\alert<handout:2>{u}\alert<handout:3>{x}{\only<handout:4>{\color{green}}mux}\alert<handout:4>{b}\alert<handout:5>{a}\alert<handout:6>{r}{\only<handout:7>{\color{green}}bar}\alert<handout:7>{m}%
