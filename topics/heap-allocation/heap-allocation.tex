...
\begin{frame}
  ...
  \vskip5mm
  \structure{Example}
  \code[frame=lines,width=.75\linewidth]{allocation-example.cpp}
\end{frame}
...
\begin{frame}
  ...
  \vskip5mm
  \structure{Example}
  \code[frame=lines,width=.75\linewidth]{initialisation-example.cpp}  
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Illegal to use pointer after {\tt delete}
  \end{itemize}
  \vskip5mm
  \structure{Example}
  \code[frame=lines,width=.75\linewidth]{delete-example.cpp}  
\end{frame}
