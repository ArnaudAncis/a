...

{
  \newcommand{\showcode}[1]{
    \onslide<#1|handout:0>
    \code[font=\small,width=.9\linewidth]{rsa#1.cpp}
  }
  \newcommand{\showcodehandout}[2]{
    \onslide<0|handout:#1>
    \code[font=\small,width=.9\linewidth]{rsa#2.cpp}
  }
...
\begin{frame}
  ...
  \code[font=\small,width=\linewidth]{timespan-addition.cpp}

  \begin{tikzpicture}[overlay,remember picture,box/.style={red,thick}]
    \only<handout:1|2>{\drawboxaround{operator}}
    \only<handout:3|4>{\drawboxaround{return type}}
    \only<handout:4|5>{\drawboxaround{const function}}
    \only<handout:5|6>{\drawboxaround{const parameter}}
  \end{tikzpicture}
...
\begin{frame}
  ...
  \code[font=\small,width=\linewidth]{timestamp-binary.cpp}
\end{frame}

\begin{frame}
  \frametitle{{\tt TimeSpan} Addition and Assignment}
  \code[font=\small,width=\linewidth]{timespan-additioneq.cpp}

  \begin{tikzpicture}[overlay,remember picture,box/.style={red,thick}]
    \only<handout:1|2>{\drawboxaround{operator}}
    \only<handout:3|4>{\drawboxaround{return type}}
    \only<handout:4|5>{\drawboxaround{nonconst function}}
    \only<handout:5|6>{\drawboxaround{const parameter}}
  \end{tikzpicture}
...
\begin{frame}
  ...
  \code[font=\small,width=\linewidth]{timespan-assignment.cpp}
...
\begin{frame}
  ...
  \end{itemize}
  \code[font=\small,width=\linewidth]{timespan-nonmember-mult.cpp}
\end{frame}
...
\begin{frame}
  ...
  \end{itemize}
  \code[font=\small,width=\linewidth]{timespan-nonmember-plus.cpp}
\end{frame}
...
\begin{frame}
  ...
  \end{itemize}
  \code[font=\small,width=\linewidth]{timespan-nonmember-plus-friend.cpp}
\end{frame}
...
\begin{frame}
  ...
  \end{itemize}
  \code[font=\small,width=\linewidth]{cin-cout.cpp}
\end{frame}
...
\begin{frame}
  ...
  \end{itemize}
  \code[font=\small,width=\linewidth]{timespan-tostring.cpp}
\end{frame}
