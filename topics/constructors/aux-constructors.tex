...
\begin{frame}
  ...
  \begin{itemize}
    \item Forcing no default constructor
          \vskip1mm
          \code[frame=lines,font=\small]{no-default-constructor.cpp}
    \item Force default constructor generation
          \vskip1mm
          \code[frame=lines,font=\small]{force-default-constructor.cpp}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    \item Custom default constructor
          \vskip1mm
          \code[frame=lines,font=\small]{custom-default-constructor.cpp}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \end{itemize}
  \code[frame=lines,font=\small]{implicit-copy-constructor.cpp}
\end{frame}
...
\begin{frame}
  \frametitle{Example}
  \code[frame=lines,font=\small]{move-constructor.cpp}
\end{frame}
...
\begin{frame}
  ...
  \begin{overprint}
    \onslide<handout:1|1>
    \code[frame=lines,font=\small]{implicit1.cpp}
    \onslide<handout:2|2>
    \code[frame=lines,font=\small]{implicit2.cpp}
  \end{overprint}
\end{frame}
...
\begin{frame}
  ...
  \end{itemize}
  \code[frame=lines,font=\small]{explicit.cpp}
\end{frame}
