...
\begin{frame}
  ...
  \code[font=\small]{overload.cpp}
\end{frame}

\begin{frame}
  \frametitle{Overloading}
  \code[font=\small,width=.9\linewidth]{container.cpp}
  \begin{overprint}
    \onslide<handout:1|1>
    \begin{center}
...
\begin{frame}
  \frametitle{Overloading}
  \code[font=\small,width=.9\linewidth]{container2.cpp}
\end{frame}
