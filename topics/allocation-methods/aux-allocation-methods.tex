...
\begin{frame}
  ...
  \begin{columns}
    \column{5cm}
    \code[font=\small,frame=none]{stack-allocation.cpp}
    \column{4cm}
    \begin{center}
...
\begin{frame}
  ...
  \end{itemize}
  \code[font=\small,width=8cm]{stack-deallocation.cpp}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    \column{5cm}
    \code[font=\small,frame=none]{heap-allocation.cpp}
    \column{4cm}
    \begin{center}
      \begin{tikzpicture}[allocation/.style={-latex,thick},remember picture,overlay,scale=.5]
        \coordinate (start) at (-4,4);
  ...
  \begin{overprint}
    ...
    \begin{center}
      \textbf{At compile time} \\ Compiler assigns memory locations to each variable \\ (this is still static allocation)
    \end{center}
