...
\begin{frame}
  ...
  \end{itemize}
  \code[font=\small,frame=lines,width=.9\linewidth]{sizeof-examples.cpp}
\end{frame}

\begin{frame}
  \frametitle{Quiz: What's the Output?}
  \code[font=\small,frame=lines,width=.9\linewidth]{sizeof-array.cpp}
\end{frame}
...
\begin{frame}
  ...
  \code[font=\small,frame=lines,width=.9\linewidth]{sizeof-array2.cpp}
\end{frame}

\begin{frame}
  \frametitle{Improved Version}
  \code[font=\small,frame=lines,width=.9\linewidth]{sizeof-array2-improved.cpp}
\end{frame}


\begin{frame}
  \frametitle{Quiz: What's the Problem?}
  \code[font=\small,frame=lines,width=.9\linewidth]{return-array.cpp}
...
\begin{frame}
  \frametitle{Quiz: What's the Problem?}
  \code[font=\small,frame=lines,width=.9\linewidth]{return-array2.cpp}
\end{frame}
...
\begin{frame}
  \frametitle{Improved Version}
  \code[font=\small,frame=lines,width=.9\linewidth]{return-array2-improved.cpp}
\end{frame}
...
\begin{frame}
  \frametitle{\tt std::array<T, N>}
  \code[frame=lines,font=\small,width=.9\linewidth]{array-usage.cpp}
\end{frame}

\begin{frame}
  \frametitle{Quiz}
  \code[frame=lines,font=\small,width=.9\linewidth]{by-value.cpp}
\end{frame}
...
\begin{frame}
  ...
  \end{itemize}
  \code[frame=lines,font=\small,width=.9\linewidth]{by-pointer.cpp}
\end{frame}
...
\begin{frame}
  ...
  \end{itemize}
  \code[frame=lines,font=\small,width=.9\linewidth]{polymorphic.cpp}
\end{frame}
...
\begin{frame}
  \frametitle{\tt std::vector<T>}
  \code[frame=lines,font=\small,width=.9\linewidth]{vector-usage.cpp}
\end{frame}
